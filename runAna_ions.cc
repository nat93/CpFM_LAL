...
int main(int argc, char *argv[])
{
    ...
    case 0:
    {
        minUnixTime_run = 1479954840000000;
        maxUnixTime_run = 1479955740000000;
        minUnixTime_cut = 1479954840000000;
        maxUnixTime_cut = 1479955740000000;
        break;
    }
    case 1:
    {
        minUnixTime_run = 1449120000000000;
        maxUnixTime_run = 1449260000000000;
        minUnixTime_cut = 1449120000000000;
        maxUnixTime_cut = 1449260000000000;
        break;
    }
    }
    ...
    TH1D* h4 = new TH1D("time_level[0]","Time at level of WF CH0",12000,-2000.0,4000.0);
    TH1D* h5 = new TH1D("time_cf[1]","CF time of max. peak CH1",12000,-2000.0,4000.0);
    TH1D* h6 = new TH1D("time_cf[2]","CF time of max. peak CH2",12000,-2000.0,4000.0);

    TH1D* h7 = new TH1D("dtime[0]-[1]","Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0);
    TH1D* h8 = new TH1D("dtime[0]-[2]","Delta (time level of WF) CH0 - (cf time of max. peak) CH2",8000,-4000.0,4000.0);
    TH1D* h9 = new TH1D("dtime[1]-[2]","Delta (cf time of max. peak) CH1 - (cf time of max. peak) CH2",8000,-4000.0,4000.0);
    ...
    TH2D* h20 = new TH2D("max_ampl_vs_time_level[0]","Maximum Amplitude of WF vs Time at level of WF CH0",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h21 = new TH2D("max_ampl_vs_time_cf[1]","Maximum Amplitude of WF vs CF time of max. peak CH1",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h22 = new TH2D("max_ampl_vs_time_cf[2]","Maximum Amplitude of WF vs CF time of max. peak CH2",12000,-2000.0,4000.0,2000,0.0,2.0);
    ...
    TH2D* h29 = new TH2D("max_ampl[1]_vs_dtime[0]-[1]","Maximum Amplitude of WF CH1 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h30 = new TH2D("max_ampl[2]_vs_dtime[0]-[2]","Maximum Amplitude of WF CH2 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);

    TH1* h33 = new TH1D("time_level_per_peak[0]","Time at level (per peak) CH0",12000,-2000.0,4000.0);
    TH1* h34 = new TH1D("time_level_per_peak[1]","Time at level (per peak) CH1",12000,-2000.0,4000.0);
    TH1* h35 = new TH1D("time_level_per_peak[2]","Time at level (per peak) CH2",12000,-2000.0,4000.0);

    TH1* h36 = new TH1D("time_level[0] - time_level_per_peak[0]","Time at level of WF CH0 - Time at level (per peak) CH0",8000,-4000.0,4000.0);
    TH1* h37 = new TH1D("time_level[0] - time_level_per_peak[1]","Time at level of WF CH0 - Time at level (per peak) CH1",8000,-4000.0,4000.0);
    TH1* h38 = new TH1D("time_level[0] - time_level_per_peak[2]","Time at level of WF CH0 - Time at level (per peak) CH2",8000,-4000.0,4000.0);

    TH2D* h39 = new TH2D("max_ampl_per_peak[0]_vs_time_level[0]-time_level_per_peak[0]","Maximum Amplitude (per peak) CH0 vs Time at level of WF CH0 - Time at level (per peak) CH0",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h40 = new TH2D("max_ampl_per_peak[1]_vs_time_level[0]-time_level_per_peak[1]","Maximum Amplitude (per peak) CH1 vs Time at level of WF CH0 - Time at level (per peak) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h41 = new TH2D("max_ampl_per_peak[2]_vs_time_level[0]-time_level_per_peak[2]","Maximum Amplitude (per peak) CH2 vs Time at level of WF CH0 - Time at level (per peak) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);
    ...
    TH1D* h62 = new TH1D("dtime_max[0]-[1]","Delta (time max of WF) CH0 - (time max of WF) CH1",8000,-4000.0,4000.0);
    TH1D* h63 = new TH1D("dtime_max[0]-[2]","Delta (time max of WF) CH0 - (time max of WF) CH2",8000,-4000.0,4000.0);
    TH1D* h64 = new TH1D("dtime_max[1]-[2]","Delta (time max of WF) CH1 - (time max of WF) CH2",8000,-4000.0,4000.0);

    TH2D* h65 = new TH2D("max_ampl_vs_time_max[0]","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH0",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h66 = new TH2D("max_ampl_vs_time_max[1]","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH1",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h67 = new TH2D("max_ampl_vs_time_max[2]","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH2",12000,-2000.0,4000.0,2000,0.0,2.0);

    TH2D* h68 = new TH2D("max_ampl[1]_vs_dtime_max[0]-[1]","Maximum Amplitude of WF CH1 vs Delta (time of maxampl. of WF) CH0 - (time of maxampl. of WF) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h69 = new TH2D("max_ampl[2]_vs_dtime_max[0]-[2]","Maximum Amplitude of WF CH2 vs Delta (time of maxampl. of WF) CH0 - (time of maxampl. of WF) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);
    ...
    TH1D* h72 = new TH1D("charge[1]","Charge of max. peak CH1",100000,-1000.0,100000.0);
    TH1D* h73 = new TH1D("charge[2]","Charge of max. peak CH2",100000,-1000.0,100000.0);
    ...
    TProfile* prof16 = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[0]","Maximum Amplitude (per peak) vs Arrival time (per peak) CH0",12000,-2000.0,4000.0,0.0,2.0);
    TProfile* prof17 = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[1]","Maximum Amplitude (per peak) vs Arrival time (per peak) CH1",12000,-2000.0,4000.0,0.0,2.0);
    TProfile* prof18 = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[2]","Maximum Amplitude (per peak) vs Arrival time (per peak) CH2",12000,-2000.0,4000.0,0.0,2.0);

    TProfile* prof19 = new TProfile("profile_max_ampl[1]_vs_dtime[0]-[1]","Profile: Maximum Amplitude of WF CH1 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0,0.0,2.0);
    TProfile* prof20 = new TProfile("profile_max_ampl[2]_vs_dtime[0]-[2]","Profile: Maximum Amplitude of WF CH2 vs Delta (time level of WF) CH0 - (cf time of max. peaks) CH2",8000,-4000.0,4000.0,0.0,2.0);
    ...
    TProfile* prof22 = new TProfile("profile_max_ampl[1]_vs_dtime_max[0]-[1]","Profile: Maximum Amplitude of WF CH1 vs Delta (time of maxampl. of max. peak) CH0 - (time of maxampl. of max. peak) CH1",8000,-4000.0,4000.0,0.0,2.0);
    TProfile* prof23 = new TProfile("profile_max_ampl[2]_vs_dtime_max[0]-[2]","Profile: Maximum Amplitude of WF CH2 vs Delta (time of maxampl. of max. peak) CH0 - (time of maxampl. of max. peak) CH2",8000,-4000.0,4000.0,0.0,2.0);
    ...
    TH1D* h7_cut = new TH1D("dtime[0]-[1]_cut","Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0);
    TH1D* h8_cut = new TH1D("dtime[0]-[2]_cut","Delta (time level of WF) CH0 - (cf time of max. peak) CH2",8000,-4000.0,4000.0);
    TH1D* h9_cut = new TH1D("dtime[1]-[2]_cut","Delta (cf time of max. peak) CH1 - (cf time of max. peak) CH2",8000,-4000.0,4000.0);
    ...
    TH2D* h20_cut = new TH2D("max_ampl_vs_time_level[0]_cut","Maximum Amplitude of WF vs Time at level of WF CH0",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h21_cut = new TH2D("max_ampl_vs_time_cf[1]_cut","Maximum Amplitude of WF vs CF time  of max. peak CH1",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h22_cut = new TH2D("max_ampl_vs_time_cf[2]_cut","Maximum Amplitude of WF vs CF time  of max. peak CH2",12000,-2000.0,4000.0,2000,0.0,2.0);
    ...
    TH2D* h29_cut = new TH2D("max_ampl[1]_vs_dtime[0]-[1]_cut","Maximum Amplitude of WF CH1 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h30_cut = new TH2D("max_ampl[2]_vs_dtime[0]-[2]_cut","Maximum Amplitude of WF CH2 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);
    ...
    TH2D* h39_cut = new TH2D("max_ampl_per_peak[0]_vs_time_level[0]-time_level_per_peak[0]_cut","Maximum Amplitude (per peak) CH0 vs Time at level of WF CH0 - Time at level (per peak) CH0",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h40_cut = new TH2D("max_ampl_per_peak[1]_vs_time_level[0]-time_level_per_peak[1]_cut","Maximum Amplitude (per peak) CH1 vs Time at level of WF CH0 - Time at level (per peak) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h41_cut = new TH2D("max_ampl_per_peak[2]_vs_time_level[0]-time_level_per_peak[2]_cut","Maximum Amplitude (per peak) CH2 vs Time at level of WF CH0 - Time at level (per peak) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);
    ...
    TH1D* h62_cut = new TH1D("dtime_max[0]-[1]_cut","Delta (time max of WF) CH0 - (time max of WF) CH1",8000,-4000.0,4000.0);
    TH1D* h63_cut = new TH1D("dtime_max[0]-[2]_cut","Delta (time max of WF) CH0 - (time max of WF) CH2",8000,-4000.0,4000.0);
    TH1D* h64_cut = new TH1D("dtime_max[1]-[2]_cut","Delta (time max of WF) CH1 - (time max of WF) CH2",8000,-4000.0,4000.0);

    TH2D* h65_cut = new TH2D("max_ampl_vs_time_max[0]_cut","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH0",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h66_cut = new TH2D("max_ampl_vs_time_max[1]_cut","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH1",12000,-2000.0,4000.0,2000,0.0,2.0);
    TH2D* h67_cut = new TH2D("max_ampl_vs_time_max[2]_cut","Maximum Amplitude of WF vs Time of MaxAmpl. of WF CH2",12000,-2000.0,4000.0,2000,0.0,2.0);

    TH2D* h68_cut = new TH2D("max_ampl[1]_vs_dtime_max[0]-[1]_cut","Maximum Amplitude of WF CH1 vs Delta (time of maxampl. of WF) CH0 - (time of maxampl. of WF) CH1",8000,-4000.0,4000.0,2000,0.0,2.0);
    TH2D* h69_cut = new TH2D("max_ampl[2]_vs_dtime_max[0]-[2]_cut","Maximum Amplitude of WF CH2 vs Delta (time of maxampl. of WF) CH0 - (time of maxampl. of WF) CH2",8000,-4000.0,4000.0,2000,0.0,2.0);
    ...
    TH1D* h72_cut = new TH1D("charge[1]_cut","Charge of max. peak CH1",100000,-1000.0,100000.0);
    TH1D* h73_cut = new TH1D("charge[2]_cut","Charge of max. peak CH2",100000,-1000.0,100000.0);
    ...
    TProfile* prof16_cut = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[0]_cut","Maximum Amplitude (per peak) vs Arrival time (per peak) CH0",12000,-2000.0,4000.0,0.0,2.0);
    TProfile* prof17_cut = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[1]_cut","Maximum Amplitude (per peak) vs Arrival time (per peak) CH1",12000,-2000.0,4000.0,0.0,2.0);
    TProfile* prof18_cut = new TProfile("profile_max_ampl_per_peak_vs_time_level_per_peak[2]_cut","Maximum Amplitude (per peak) vs Arrival time (per peak) CH2",12000,-2000.0,4000.0,0.0,2.0);

    TProfile* prof19_cut = new TProfile("profile_max_ampl[1]_vs_dtime[0]-[1]_cut","Profile: Maximum Amplitude of WF CH1 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH1",8000,-4000.0,4000.0,0.0,2.0);
    TProfile* prof20_cut = new TProfile("profile_max_ampl[2]_vs_dtime[0]-[2]_cut","Profile: Maximum Amplitude of WF CH2 vs Delta (time level of WF) CH0 - (cf time of max. peak) CH2",8000,-4000.0,4000.0,0.0,2.0);
    ...
    TProfile* prof22_cut = new TProfile("profile_max_ampl[1]_vs_dtime_max[0]-[1]_cut","Profile: Maximum Amplitude of WF CH1 vs Delta (time of maxampl. of max. peak) CH0 - (time of maxampl. of max. peak) CH1",8000,-4000.0,4000.0,0.0,2.0);
    TProfile* prof23_cut = new TProfile("profile_max_ampl[2]_vs_dtime_max[0]-[2]_cut","Profile: Maximum Amplitude of WF CH2 vs Delta (time of maxampl. of max. peak) CH0 - (time of maxampl. of max. peak) CH2",8000,-4000.0,4000.0,0.0,2.0);
    ...
    for(Int_t eventID = 0; eventID < nEntries; eventID++)
    {
        ...
        if(untime < minUnixTime_cut || untime > maxUnixTime_cut) continue;
        ...
        //CpFM1 CHANNEL
        if(max_ampl[1] > 0.1 && max_ampl[1] < 1.2)
        {
        ...
        //CpFM2 CHANNEL
        if(max_ampl[2] > 0.1 && max_ampl[2] < 1.2)
        {
